...
*/}}
{{- define "enclave.resourceName" -}}
{{- $fullname := include "enclave.fullname" .context }}
{{- $suffix := .suffix }}
...
{{- else }}
{{- include "enclave.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
